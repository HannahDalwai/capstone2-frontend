...
<section class="single-block-wrapper section-padding">
    ...
    <div class="post-header mb-5 text-center">
        ...
        <div class="post-featured-image mt-5">
            <img src="https://i.postimg.cc/NjqQnjfL/reading.jpg" class="img-fluid w-100" alt="featured-image">
        </div>
    </div>
    <div class="post-body">
	...
	<div class="sidebar-widget mb-5 ">
		...
		<div class="sidebar-post-item-big">
			<a href="blog-single.html"><img src="https://i.postimg.cc/NjqQnjfL/reading.jpg" alt="" class="img-fluid"></a>
        ...
        <div class="media border-bottom py-3 sidebar-post-item">
            <a href="#"><img class="mr-4" src="https://i.postimg.cc/NjqQnjfL/reading.jpg" alt=""></a>
